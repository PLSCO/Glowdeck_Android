...
import com.plsco.glowdeck.services.Constants;
    ...
    public void onBackPressed() {
        try {
            if ((msStreamsState == StreamsScreenState.DEVICES_VIEW) || (msStreamsState == StreamsScreenState.DEVICES_VIEW_DEVICES)) {
                ...
                } else if (msStreamsState == StreamsScreenState.DEVICES_VIEW_DEVICES) {
                    try {
                        msStreamsState = msPrevStreamsState;
...
//                else
    ...
    protected void startIntentService() {
        ...
        editor.putFloat(LoginActivity.PrefsLatitude, (float) mLastKnownLocation.getLatitude());
        editor.putFloat(LoginActivity.PrefsLongitude, (float) mLastKnownLocation.getLongitude());
        editor.commit();

        Intent intent = new Intent(this, RetrieveService.class);
